...
public class PutongguanliyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		PutongguanliyuanEntity user = putongguanliyuanService.selectOne(new EntityWrapper<PutongguanliyuanEntity>().eq("guanlizhanghao", username));
    ...
    public R register(@RequestBody PutongguanliyuanEntity putongguanliyuan){
    	...
    	PutongguanliyuanEntity user = putongguanliyuanService.selectOne(new EntityWrapper<PutongguanliyuanEntity>().eq("guanlizhanghao", putongguanliyuan.getGuanlizhanghao()));
		if(user!=null) {
