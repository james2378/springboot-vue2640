<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<style>
		.top-brand {
			...
			background-color: rgba(140, 149, 112, 1);
		...
		.top-brand .navbar-default {
			...
			border-style: solid;
			border-color: rgba(0,0,0,.3);
			background-color: rgba(212, 227, 169, 1);
		...
		.top-brand .nav .dropdown-menu.profile::before {
			left: 100%;
			margin-left: -28px;
			border-bottom-color: rgba(255, 241, 117, 0.48);
		}
		...
		.top-brand .nav .dropdown-menu.profile h5 {
			...
			border-style: solid;
			border-color: #333;
			background-color: rgba(255, 241, 117, 0.48);
			box-shadow: 0 0 6px rgba(30, 144, 255, 0);
			text-align: center;
		}
		...
		.top-brand .nav .dropdown-menu.profile .web:hover{
			...
			border-style: solid;
			border-color: rgba(0,0,0,.3);
			background-color: rgba(255, 241, 117, 0.53);
			box-shadow: 0 0 6px rgba(30, 144, 255, 0);
		}
				...
				<div class="container top-brand" style="display: flex;">
					...
					<nav class="navbar navbar-default">			
						<div class="navbar-header">
							<a href="${pageContext.request.contextPath}/index.jsp">图书管理系统</a>
						</div>
