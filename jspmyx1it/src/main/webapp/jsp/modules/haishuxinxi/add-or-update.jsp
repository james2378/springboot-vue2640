		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑还书信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>还书信息管理</span></li>
								<li class="breadcrumb-item active"><span>编辑还书信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">还书信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>类型</label>
										<input name="leixing" id="leixing" name="leixing" class="form-control" placeholder="类型">
									</div>
									<div class="form-group col-md-6">
										<label>数量</label>
									...
									<div class="form-group col-md-6">
										<label>预计归还</label>
										<input name="yujiguihai" id="yujiguihai" name="yujiguihai" class="form-control" placeholder="预计归还">
									</div>
									<div class="form-group col-md-6">
										<label>账号</label>
									...
									<div class="form-group col-md-6">
										<label>借书时间</label>
										<input name="jieshushijian" id="jieshushijian" name="jieshushijian" class="form-control" placeholder="借书时间">
									</div>
									<div class="form-group col-md-6">
										<label>还书备注</label>
										<input name="haishubeizhu" id="haishubeizhu" name="haishubeizhu" class="form-control" placeholder="还书备注">
									</div>
									<div class="form-group col-md-6">
										<label>还书时间</label>
										<div id="haishushijianDate" class="input-append date form_datetime">
											<input id="haishushijian-input" name="haishushijian" size="15" type="text" readonly>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "haishuxinxi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("haishuxinxi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("haishuxinxi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("haishuxinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#haishushijian-input").val(getCurDate());
			$("#haishushijianDate").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
		...
		function dataBind(){
			...
			$("#yujiguihai").val(ruleForm.yujiguihai);	
			...
			$("#haishubeizhu").val(ruleForm.haishubeizhu);	
			$("#haishushijian-input").val(ruleForm.haishushijian);
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.leixing != null && res.data.leixing != ''){
						...
						$("#leixing").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.yujiguihai != null && res.data.yujiguihai != ''){

						$("#yujiguihai").val(res.data.yujiguihai);
						$("#yujiguihai").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.haishubeizhu != null && res.data.haishubeizhu != ''){

						$("#haishubeizhu").val(res.data.haishubeizhu);
						$("#haishubeizhu").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.haishushijian != null && res.data.haishushijian != ''){

						$("#haishushijian-input").val(res.data.haishushijian);
						$('#haishushijianFileName').val(res.data.haishushijian)
					}
