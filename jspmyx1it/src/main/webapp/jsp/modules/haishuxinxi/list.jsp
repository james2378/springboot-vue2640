...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">还书信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>还书信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">还书信息列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="leixingSearch" class="form-control form-control-sm" placeholder="请输入类型" aria-controls="tableId">
									<label>
										预计归还
									</label>
									<input type="text" id="yujiguihaiSearch" class="form-control form-control-sm" placeholder="请输入预计归还" aria-controls="tableId">
									<label>
										姓名
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('yujiguihai')">预计归还<i id="yujiguihaiIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('jieshushijian')">借书时间<i id="jieshushijianIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('haishubeizhu')">还书备注<i id="haishubeizhuIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('haishushijian')">还书时间<i id="haishushijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			if($('#yujiguihaiSearch').val() != null && $('#yujiguihaiSearch').val() != ''){
				searchForm.yujiguihai ="%" +  $('#yujiguihaiSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("haishuxinxi/page","GET",{
				...
				yujiguihai : searchForm.yujiguihai,	
		...
		function setDataRow(item,number){
			...
			var yujiguihaiCell  = document.createElement('td');

						 yujiguihaiCell.innerHTML = item.yujiguihai;

			row.appendChild(yujiguihaiCell);
			...
			var haishubeizhuCell  = document.createElement('td');

						 haishubeizhuCell.innerHTML = item.haishubeizhu;

			row.appendChild(haishubeizhuCell);
			var haishushijianCell  = document.createElement('td');

						  haishushijianCell.innerHTML = item.haishushijian;


			row.appendChild(haishushijianCell);
		...
		function sh(){
			...
			httpJson("haishuxinxi/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("haishuxinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"haishuxinxi");
