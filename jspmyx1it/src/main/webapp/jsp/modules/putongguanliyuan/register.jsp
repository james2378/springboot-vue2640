	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">管理账号</label> 
							<input  name="guanlizhanghao" placeholder="管理账号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">管理姓名</label> 
							<input  name="guanlixingming" placeholder="管理姓名" class="form-control-i">
							</div>
							<div class="form-group">
