		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑普通管理员</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑普通管理员</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">普通管理员信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>管理账号</label>
										<input name="guanlizhanghao" id="guanlizhanghao" name="guanlizhanghao" class="form-control" placeholder="管理账号">
									</div>
									<div class="form-group col-md-6">
										<label>密码</label>
									...
									<div class="form-group col-md-6">
										<label>管理姓名</label>
										<input name="guanlixingming" id="guanlixingming" name="guanlixingming" class="form-control" placeholder="管理姓名">
									</div>
									<div class="form-group col-md-6">
										<label>性别</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "putongguanliyuan/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("putongguanliyuan/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("putongguanliyuan/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("putongguanliyuan/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#guanlizhanghao").val(ruleForm.guanlizhanghao);	
			$("#mima").val(ruleForm.mima);	
			$("#guanlixingming").val(ruleForm.guanlixingming);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.guanlizhanghao != null && res.data.guanlizhanghao != ''){

						$("#guanlizhanghao").val(res.data.guanlizhanghao);
						$("#guanlizhanghao").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.guanlixingming != null && res.data.guanlixingming != ''){

						$("#guanlixingming").val(res.data.guanlixingming);
						$("#guanlixingming").attr('readonly','readonly');
					}
