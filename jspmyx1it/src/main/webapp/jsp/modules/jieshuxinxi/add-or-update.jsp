...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑借书信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑借书信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">借书信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>预计归还</label>
										<div id="yujiguihaiDate" class="input-append date form_datetime">
											<input id="yujiguihai-input" name="yujiguihai" size="15" type="text" readonly>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "jieshuxinxi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("jieshuxinxi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("jieshuxinxi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function dateTimePick(){
			...
			$("#yujiguihaiDate").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
			});
			$("#jieshushijian-input").val(getCurDate());
		...
		function dataBind(){
			...
			$("#yujiguihai-input").val(ruleForm.yujiguihai);
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.yujiguihai != null && res.data.yujiguihai != ''){
						...
						$("#yujiguihai-input").val(res.data.yujiguihai);
						$('#yujiguihaiFileName').val(res.data.yujiguihai)
					}
