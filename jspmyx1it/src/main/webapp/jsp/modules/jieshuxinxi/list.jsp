...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">借书信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>借书信息管理</span></li>
								<li class="breadcrumb-item active"><span>借书信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">借书信息列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<label>预计归还</label>
									<input id="yujiguihai_start" class="Wdate form-control form-control-sm" type="text" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd'})">
									至
									<input id="yujiguihai_end" class="Wdate form-control form-control-sm" type="text" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd'})">
									<label>
										姓名
									</label>
	...
	<script>
		...
		function search(){
			...
			if($('#yujiguihai_start').val() != null && $('#yujiguihai_start').val() != ''){
				searchForm.yujiguihai_start = $('#yujiguihai_start').val();
			}
			if($('#yujiguihai_end').val() != null && $('#yujiguihai_end').val() != ''){
				searchForm.yujiguihai_end = $('#yujiguihai_end').val();
			}
        ...
        function getDataList() {
			http("jieshuxinxi/page","GET",{
				...
				yujiguihai_start : searchForm.yujiguihai_start,
				yujiguihai_end : searchForm.yujiguihai_end,
		...
		function setDataRow(item,number){
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "还书"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'haishuxinxi','是','','')");
			if(crossBtnControl('还书') == true){
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("jieshuxinxi/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("jieshuxinxi/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("jieshuxinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"jieshuxinxi");
