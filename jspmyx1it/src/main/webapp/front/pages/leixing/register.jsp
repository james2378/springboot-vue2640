...
<html>
	...
	<body>
			...
			<form class="layui-form login-form" :style='{"padding":"80px","boxShadow":"0 0 0px 30px #0A58A2","borderColor":"rgba(255, 255, 255, 1)","backgroundColor":"rgba(178, 231, 177, 1)","borderRadius":"50%","borderWidth":"10px","width":"600px","borderStyle":"solid","justifyContent":"center","height":"auto"}'>
				...
				<div class="title" v-if="true" :style='{"padding":"0","boxShadow":"0px 0px 0 0px rgba(110,22,64,.8)","margin":"10px auto","borderColor":"rgba(10, 88, 162, 1)","backgroundColor":"rgba(0,0,0,0)","color":"rgba(10, 88, 162, 1)","isshow":true,"borderRadius":"0","borderWidth":"5px","width":"80%","lineHeight":"38px","fontSize":"18px","borderStyle":"solid"}'>类型注册</p></div>
